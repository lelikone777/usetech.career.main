                ...
                <div class="col-lg-12">
                    ...
                    <section class="vacancy-tab">
                        <ul class="nav nav-pills nav-vert">
                          ...
                          <li role="presentation" class="active"><a href="/vacancy/pm/">Управление проектами</a></li>
                        </ul>
                    </section>
                    ...
                    <div class="vacancy-item">
                        <div class="row">
                         ...
                         <?php
                            $args=array(
                            'category__in' => 10, //из какой категории вывести (удалите эту строку, если хотите, чтобы показовало последние материалы из всех рубрик сразу)
