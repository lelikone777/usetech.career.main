...
jQuery('#uploaded-file1').change(function() {
        ...
        try { 				
            ...
            if (file) { 					
                ...
                document.getElementById('file-name1').innerHTML = '<b>Файл:</b> ' + file.name;
                document.getElementById('file-size1').innerHTML = '<b>Размер:</b> ' + fileSize;
            ...
            document.getElementById('file-name1').innerHTML = '<b>Файл:</b> ' + file;
        }
});
});
