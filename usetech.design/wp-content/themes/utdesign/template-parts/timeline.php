<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/js/scrollTo.js"></script>
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri(); ?>/js/timeline.js"></script>
<?php
    ...
    <div class="timeline__body-timeline">
        ...
        <div id="timeline__nav" class="timeline__nav">
            ...
            for($i = 0; $i <= $count_year - 1; $i++){
                echo "<span id='". $i ."' class='timeline__nav-item";
                if($i == $count_year - 1) echo " active";
                echo "'>". $keys_year[$i] ."</span>";
            }
            */
            for($i = $start_year; $i <= $current_year; $i++){
                            echo "<span id='". $i ."' class='timeline__nav-item";
                            if($i == $current_year) echo " active";
                            echo "'>". $i ."</span>";
                        }
            ?>
        </div>
